...
Find your session file:
    ls -t ~/.claude/projects/*/sessions/*.jsonl | head -5
"""
...
def calculate_cost(usage, input_cost_per_m=3.0, output_cost_per_m=15.0):
    """Calculate estimated cost in dollars (Sonnet 4.6 pricing)."""
...
def main():
    if len(sys.argv) < 2:
        ...
        print()
        print("Find your session file:")
        print("  ls -t ~/.claude/projects/*/sessions/*.jsonl | head -5")
        sys.exit(1)
    ...
    print("=" * 100)
    print("TOKEN USAGE ANALYSIS — DATAPOWERS SESSION")
    print("=" * 100)
    print()
    ...
    print("  (at $3/$15 per M tokens for input/output — Sonnet 4.6 pricing)")
    print()
    print("=" * 100)
