...
while [[ $# -gt 0 ]]; do
    case $1 in
        ...
        --help|-h)
            ...
            echo ""
            echo "Fast Tests (default):"
            echo "  test-subagent-driven-analysis.sh  Test skill loading and requirements"
            echo ""
            echo "Integration Tests (use --integration):"
            echo "  test-subagent-driven-analysis-integration.sh  Full workflow execution"
            exit 0
            ;;
        *)
...
tests=(
    ...
    "test-verification-before-delivery.sh"
)
